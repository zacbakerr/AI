...
global ALPHA, EPOHCS, INPUTLENGTH, OUTPUTLENGTH, NUMHIDDENLAYERS, HIDDENLAYERLENGTHS
ALPHA = [0.1]
EPOCHS = [1000]
INPUTLENGTH = [784]
OUTPUTLENGTH = [10]
NUMHIDDENLAYERS = [2]
HIDDENLAYERLENGTHS = [[300, 100]]
...
def main():
    # parse inputs and outputs (currently setup for mnist data set)
    inputs = []
    outputs = []
    ...
    layerLengths = HIDDENLAYERLENGTHS[0] + [outputLength]
    for numOfNodes in layerLengths:
